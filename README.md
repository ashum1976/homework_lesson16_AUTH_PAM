...
- [Скрипт проверки пользователяpam](script_auth) - Скрипт проверки пользователя на стенде, копируется в каталог /etc/pam-script.d/
- [Основной скрипт ](sec_script.sh) - Основной выполняемый скрипт при запуске vagrant-стенда, "prod.vm.provision" в Vagrantfile
